...
const items=["./assets/img-1.jpg","./assets/img-2.jpg","./assets/img-3.jpg","./assets/img-4.jpg"];
...
const grid=document.getElementById('grid'); const dlg=document.getElementById('dlg'); const dlgImg=document.getElementById('dlgImg');
items.forEach(src=>{ const div=document.createElement('div'); div.className='card'; div.style.padding='0'; div.style.overflow='hidden'; div.innerHTML='<img src="'+src+'" alt="portfolio" style="width:100%;height:200px;object-fit:cover;display:block;cursor:zoom-in;">'; div.onclick=()=>{ dlgImg.src=src; dlg.showModal(); }; grid.appendChild(div); });
