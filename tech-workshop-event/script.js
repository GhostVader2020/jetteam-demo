...
// Agenda accordion
const agenda = [
  {t:"09:00", d:"Coffee & Registration"},
  {t:"09:30", d:"Session 1 — Modern HTML Patterns"},
  {t:"11:00", d:"Break"},
  {t:"11:15", d:"Session 2 — CSS Layouts (Grid/Flex)"},
  {t:"12:45", d:"Lunch"},
  {t:"13:30", d:"Session 3 — JS Interactivity"},
  {t:"15:00", d:"Q&A and Wrap"}
];
const wrap = document.getElementById('interactive-wrap');
wrap.innerHTML = '<div id="agenda"></div>';
const container = document.getElementById('agenda');
agenda.forEach(item=>{
  const d=document.createElement('details');
  d.className='card';
  const s=document.createElement('summary');
  s.textContent=item.t + ' — ' + item.d.split(' — ')[0];
